...
@Component({
  selector: 'app-g6-graph-demo',
  templateUrl: './g6-graph-demo.component.html',
  styleUrls: ['./g6-graph-demo.component.less']
})
export class G6GraphDemoComponent implements OnInit {
